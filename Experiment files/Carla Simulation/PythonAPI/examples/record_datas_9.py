...
ff = open('vehicle_output_9.txt','w')
...
class KeyboardControl(object):
    ...
    def parse_events(self, client, world, clock,qtoggle):
        if qtoggle:
            qtoggle = False
...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            image.save_to_disk('vehicle_data_9/%08d' % image.frame)
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            if controller.parse_events(client, world, clock,qtoggle):
                return
            qtoggle = False
            world.tick(clock)
        ...
        if world is not None:
            world.destroy()
        #data.to_csv("vehicle_output_1.csv".format(args.name))
