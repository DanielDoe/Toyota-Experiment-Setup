...
#ifndef AddThreeInts_Plugin_330796887_h
#define AddThreeInts_Plugin_330796887_h
...
namespace tutorial_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define AddThreeInts_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define AddThreeInts_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define AddThreeInts_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define AddThreeInts_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define AddThreeInts_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern AddThreeInts_Request_*
            ...
            AddThreeInts_Request_PluginSupport_copy_data(
                AddThreeInts_Request_ *out,
                const AddThreeInts_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            AddThreeInts_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            AddThreeInts_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                AddThreeInts_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            AddThreeInts_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AddThreeInts_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            AddThreeInts_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            AddThreeInts_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace tutorial_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define AddThreeInts_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define AddThreeInts_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define AddThreeInts_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define AddThreeInts_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define AddThreeInts_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern AddThreeInts_Response_*
            ...
            AddThreeInts_Response_PluginSupport_copy_data(
                AddThreeInts_Response_ *out,
                const AddThreeInts_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            AddThreeInts_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            AddThreeInts_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                AddThreeInts_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            AddThreeInts_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                AddThreeInts_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            AddThreeInts_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            AddThreeInts_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* AddThreeInts_Plugin_330796887_h */
