  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const tutorial_interfaces::srv::AddThreeInts_Request & ros_message =
    *(const tutorial_interfaces::srv::AddThreeInts_Request *)untyped_ros_message;

  // create a respective connext dds type
  tutorial_interfaces::srv::dds_::AddThreeInts_Request_ * dds_message = tutorial_interfaces::srv::dds_::AddThreeInts_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  tutorial_interfaces::srv::AddThreeInts_Request & ros_message =
    *(tutorial_interfaces::srv::AddThreeInts_Request *)untyped_ros_message;
...
{
  return &tutorial_interfaces::srv::typesupport_connext_cpp::_AddThreeInts_Request__handle;
}
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const tutorial_interfaces::srv::AddThreeInts_Response & ros_message =
    *(const tutorial_interfaces::srv::AddThreeInts_Response *)untyped_ros_message;

  // create a respective connext dds type
  tutorial_interfaces::srv::dds_::AddThreeInts_Response_ * dds_message = tutorial_interfaces::srv::dds_::AddThreeInts_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  tutorial_interfaces::srv::AddThreeInts_Response & ros_message =
    *(tutorial_interfaces::srv::AddThreeInts_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (tutorial_interfaces::srv::dds_::AddThreeInts_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &tutorial_interfaces::srv::typesupport_connext_cpp::_AddThreeInts_Response__handle;
}
...
void * create_requester__AddThreeInts(
...
const char * destroy_requester__AddThreeInts(
...
int64_t send_request__AddThreeInts(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = tutorial_interfaces::srv::AddThreeInts_Request;
  using RequesterType = connext::Requester<
    tutorial_interfaces::srv::dds_::AddThreeInts_Request_,
    tutorial_interfaces::srv::dds_::AddThreeInts_Response_
  >;
  connext::WriteSample<
    tutorial_interfaces::srv::dds_::AddThreeInts_Request_> request;
  const ROSRequestType & ros_request = *(
    static_cast<const ROSRequestType *>(untyped_ros_request));
  tutorial_interfaces::srv::typesupport_connext_cpp::convert_ros_message_to_dds(
...
void * create_replier__AddThreeInts(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__AddThreeInts(
...
bool take_request__AddThreeInts(
  void * untyped_replier,
  ...
  void * untyped_ros_request)
{
  ...
  bool converted =
    tutorial_interfaces::srv::typesupport_connext_cpp::convert_dds_message_to_ros(request.data(), ros_request);
  if (!converted) {
    return false;
  }
...
bool take_response__AddThreeInts(
  void * untyped_requester,
  rmw_service_info_t * request_header,
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    tutorial_interfaces::srv::dds_::AddThreeInts_Response_
  >;
  using ROSResponseType = tutorial_interfaces::srv::AddThreeInts_Response;
  ...
  bool converted =
    tutorial_interfaces::srv::typesupport_connext_cpp::convert_dds_message_to_ros(response.data(), ros_response);
  return converted;
}
...
{
  using ROSResponseType = const tutorial_interfaces::srv::AddThreeInts_Response;
  using ReplierType = connext::Replier<
    tutorial_interfaces::srv::dds_::AddThreeInts_Request_,
    tutorial_interfaces::srv::dds_::AddThreeInts_Response_
  >;
  ...
  bool converted =
    tutorial_interfaces::srv::typesupport_connext_cpp::convert_ros_message_to_dds(ros_response, response.data());
  if (!converted) {
    return false;
  }
...
{
  return &tutorial_interfaces::srv::typesupport_connext_cpp::_AddThreeInts__handle;
}
